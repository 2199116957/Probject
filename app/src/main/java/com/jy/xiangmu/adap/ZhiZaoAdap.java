...
public class ZhiZaoAdap extends DelegateAdapter.Adapter {
    ...
    public ZhiZaoAdap(GridLayoutHelper gridLayoutHelper, Context context, ArrayList<ZhiZaoBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_zzs_home, parent, false);
